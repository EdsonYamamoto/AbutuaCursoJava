...
public class Data {
		...
		public int getDiasCorridos()
		{
			...
			getMaxDiaMes(this.mes, this.ano);
			return ano;
		}
		...
		public int diferencaData(int dia, int mes, int ano)
		{/*
			int d, m, a;
			d=this.dia-dia;
		...
		public int diferencaData(String string)
		{
			...
			int mes = Integer.parseInt(array[1]);
			int ano = Integer.parseInt(array[2]);
			return diferencaData(dia, mes, ano);
		}
		public int diferencaData(Data data)
		{
			return diferencaData(data.dia, data.mes, data.ano);
		}
		...
		{
			Data d1 = new Data("18/02/1900");
			Data d2 = new Data(1,2,1);
